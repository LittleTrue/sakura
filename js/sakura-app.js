            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://gcore.jsdelivr.net/gh/LittleTrue/sakura-cdn@3.0.2/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                        lazyload();
...
function coverVideoIni() {
    if ($('video').hasClass('hls')) {
        if (mashiro_global.variables.has_hls){
            ...
            $.getScript("https://gcore.jsdelivr.net/gh/LittleTrue/Sakura@3.3.3/cdn/js/src/16.hls.js", function(){
                loadHls();
...
loadCSS("https://gcore.jsdelivr.net/npm/aplayer@1.10.1/dist/APlayer.min.css");
loadCSS("https://fonts.lug.ustc.edu.cn/css?family=Noto+SerifMerriweather|Merriweather+Sans|Source+Code+Pro|Ubuntu:400,700|Noto+Serif+SC");
