...
function optionsframework_options()
{
    ...
    $options[] = array(
        ...
        'id' => 'cover_cdn',
        'std' => 'https://fastly.jsdelivr.net/LittleTrue/sakura@3.3.3',
        'type' => 'text');
    ...
    $options[] = array(
        ...
        'id' => 'lazyload_spinner',
        'std' => 'https://fastly.jsdelivr.net/LittleTrue/sakura-cdn@3.0.2/img/svg/loader/trans.ajax-spinner-preloader.svg',
        'type' => 'text');
