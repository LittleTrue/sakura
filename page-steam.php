 ...
 *  Modify By LittleTrue 增加个性化的Steam配置
 */
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<script type="text/javascript">
			window.jQuery || document.write('<script src="https://gcore.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.min.js"><\/script>')
		</script>
		<script src="https://gcore.jsdelivr.net/npm/lazyload@2.0.0-rc.2/lazyload.js"></script>
		<script type="text/javascript">
