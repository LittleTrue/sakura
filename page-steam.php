...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<script type="text/javascript">
			window.jQuery || document.write('<script src="https://data.jsdelivr.com/npm/jquery@3.6.0/dist/jquery.min.js"><\/script>')
		</script>
		<script src="https://data.jsdelivr.com/npm/lazyload@2.0.0-rc.2/lazyload.js"></script>
		<script type="text/javascript">
