...
mashiro_option.skin_bg7 = "https://cdn.jsdelivr.net/gh/LittleTrue/sakura-cdn@3.1.2/other-sites/api-index/images/me.png";
<?php } ?>
...
<?php } else { ?>
mashiro_option.jsdelivr_css_src = "https://cdn.jsdelivr.net/gh/LittleTrue/Sakura@<?php echo SAKURA_VERSION; ?>/cdn/css/lib.min.css";
<?php } ?>
