...
mashiro_option.skin_bg7 = "https://fastly.jsdelivr.net/LittleTrue/sakura-cdn@3.1.2/other-sites/api-index/images/me.png";
<?php } ?>
...
<?php } else { ?>
mashiro_option.jsdelivr_css_src = "https://fastly.jsdelivr.net/LittleTrue/Sakura@<?php echo SAKURA_VERSION; ?>/cdn/css/lib.min.css";
<?php } ?>
